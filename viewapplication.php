...
<button onclick="PrintDiv()" name="print">Print Report</button>
<html>
    <head>
           <style>
#approve {
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example" align="center">
                                    <thead>
                                        <table id ="approve"  class="content-table">
                                            ...
                                            $query="SELECT * From tbl_caste ORDER BY Regid ASC";
...
error_reporting(E_ALL);
                        ...
                        $date_query = mysqli_query($conn, "select *from tbl_caste");
