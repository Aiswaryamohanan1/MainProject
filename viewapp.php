            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <input type="button" class="btn btn-primary mr-2" onclick="window.location.href = 'order_pdf.php'"  value="Print"/>
...
$sql=mysqli_query($conn,"SELECT * from tbl_caste where status='review pending'");
   ...
   while($display=mysqli_fetch_array($sql))
   {
	...
	?> <td><button class="btn btn-primary" ><a href="display_pdf.php?id=<?php echo $display['email']?>"style="color:white;">View</a></button></td>
z     <td><button class="btn btn-primary" ><a href="approvese.php?id=<?php echo $display['Regid'];?>"style="color:white;">Approve</a></button> </td>
     <td><button class="btn btn-danger" ><a href="rejectse.php?id=<?php echo $display['Regid'];?>"style="color:white;">Reject</a></button> </td>
