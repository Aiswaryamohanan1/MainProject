...
$sql=mysqli_query($conn,"SELECT * from tbl_leave where leavestatus='0'");
   ...
   while($display=mysqli_fetch_array($sql))
   {
	...
	?>
     <td><button class="btn btn-primary" ><a href="approve.php?id=<?php echo $display['tid'];?>"style="color:white;">Approve</a></button> </td>
     <td><button class="btn btn-danger" ><a href="reject.php?id=<?php echo $display['tid'];?>"style="color:white;">Reject</a></button> </td>
